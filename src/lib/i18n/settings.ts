...
const settingsCopy: Record<Locale, SettingsCopy> = {
  en: {
    ...
    traders: {
      ...
      passwordRequired: "Enter your current password to confirm this change.",
      ...
      confirmPasswordLabel: "Current password (to confirm it's you)",
  ...
  fr: {
    ...
    traders: {
      ...
      passwordRequired: "Entre ton mot de passe actuel pour confirmer ce changement.",
      ...
      confirmPasswordLabel: "Mot de passe actuel (pour confirmer que c'est toi)",
